                            ...
                            <div style={{ background: 'var(--bg-light)', padding: '30px', borderRadius: '20px' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0 }}>
                                    {[
                                        ...
                                        <li key={i} style={{ marginBottom: '15px', display: 'flex', gap: '10px', fontSize: '0.95rem', color: 'var(--text-muted)' }}>
                            ...
                            <div style={{ background: 'white', padding: '30px', borderRadius: '20px', boxShadow: 'var(--shadow-md)', border: '1px solid #eee' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0 }}>
                                    {[
                                        ...
                                        <li key={i} style={{ marginBottom: '12px', display: 'flex', gap: '10px', fontSize: '0.95rem', color: 'var(--text-muted)' }}>
                        ...
                        <div className="program-stats">
                            ...
                            <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                                {activeSemData?.totalCredits && (
                                    <div className="stat-badge" style={{ background: 'rgba(128,0,0,0.05)', color: 'var(--primary)' }}>
                                        <i className="fas fa-graduation-cap"></i> Total Credits: {activeSemData.totalCredits}
                                    </div>
                                )}
                                <div className="stat-badge" style={{ background: 'rgba(255,193,7,0.1)', color: 'var(--primary)' }}>
                                    <i className="far fa-clock"></i> Total Hours: {activeSemData?.totalHours}
                                </div>
                            </div>
                        </div>
