...
const Organogram = () => {
    ...
    return (
        <div className="organogram-page">
            {/* Inner Hero */}
            <div className="inner-hero" style={{ background: 'var(--primary)', color: 'white', textAlign: 'center', padding: '100px 0' }}>
                <div className="container">
                    <span className="estd-tag" style={{ background: 'var(--accent)', color: 'var(--primary)' }}>GOVERNANCE STRUCTURE</span>
                    <h1 style={{ fontSize: '3rem', margin: '20px 0' }} className="reveal">Institutional Organogram</h1>
