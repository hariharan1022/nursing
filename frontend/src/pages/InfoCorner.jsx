                        ...
                        <div className="info-content">
                            ...
                            <div id="announcements" className="reveal" style={{ marginBottom: '60px' }}>
                                ...
                                {announcements.map((ann, idx) => (
                                    <div key={idx} className="hover-lift" style={{ background: 'white', padding: '25px', borderRadius: '15px', borderLeft: '5px solid var(--accent)', boxShadow: 'var(--shadow-sm)', marginBottom: '20px' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                                            <span style={{ fontSize: '0.75rem', fontWeight: 800, color: 'var(--primary)', background: 'var(--bg-light)', padding: '4px 12px', borderRadius: '50px' }}>{ann.type}</span>
                                        </div>
                            ...
                            <div id="news" className="reveal" style={{ marginBottom: '60px' }}>
                                ...
                                {newsEvents.map((news, idx) => (
                                    <div key={idx} className="hover-lift" style={{ background: 'white', padding: '25px', borderRadius: '15px', borderLeft: '5px solid var(--primary)', boxShadow: 'var(--shadow-sm)', marginBottom: '20px' }}>
                                        <span style={{ fontSize: '0.75rem', fontWeight: 800, color: 'white', background: 'var(--primary)', padding: '4px 12px', borderRadius: '50px', display: 'inline-block', marginBottom: '10px' }}>{news.type}</span>
                            ...
                            <div id="achievements" className="reveal" style={{ marginBottom: '60px' }}>
                                ...
                                {rankHolders.map((group, idx) => (
                                    <div key={idx} style={{ background: 'white', padding: '30px', borderRadius: '20px', boxShadow: 'var(--shadow-sm)', marginBottom: '30px', border: '1px solid #eee' }}>
                            ...
                            <div id="jobs" className="reveal">
                                ...
                                <div style={{ background: 'var(--primary)', color: 'white', padding: '40px', borderRadius: '25px', textAlign: 'center' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
                                        <a href="mailto:jobs@mzcn.in" className="btn" style={{ background: 'var(--accent)', color: 'var(--primary)', fontWeight: 800 }}>APPLY NOW</a>
